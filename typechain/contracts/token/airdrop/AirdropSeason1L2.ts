...
export interface AirdropSeason1L2Interface extends utils.Interface {
  functions: {
...
export interface AirdropSeason1L2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AirdropSeason1L2Interface;
