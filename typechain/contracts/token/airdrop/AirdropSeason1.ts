...
export interface AirdropSeason1Interface extends utils.Interface {
  functions: {
    "authorize(address)": FunctionFragment;
    "authorized(address)": FunctionFragment;
    "claim(uint128,bytes32[])": FunctionFragment;
    "claimAndStake(address,uint128,bytes32[],uint8)": FunctionFragment;
  ...
  events: {
    "Claimed(address,uint128)": EventFragment;
...
export interface AirdropSeason1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AirdropSeason1Interface;
