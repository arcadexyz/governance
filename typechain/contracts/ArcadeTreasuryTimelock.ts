...
export interface ArcadeTreasuryTimelockInterface extends utils.Interface {
  functions: {
...
export interface ArcadeTreasuryTimelock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ArcadeTreasuryTimelockInterface;
