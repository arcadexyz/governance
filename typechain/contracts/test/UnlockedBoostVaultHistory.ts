...
export interface UnlockedBoostVaultHistoryInterface extends utils.Interface {
  functions: {
...
export interface UnlockedBoostVaultHistory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UnlockedBoostVaultHistoryInterface;
