...
export interface UnlockedBoostVaultInterface extends utils.Interface {
  functions: {
    "MAX_HISTORY_LENGTH()": FunctionFragment;
    ...
    "getMultiplierExpiration(address,uint128)": FunctionFragment;
    ...
    "setMultiplier(address,uint128,uint128,uint128)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "MAX_HISTORY_LENGTH",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getMultiplierExpiration",
    values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "MultiplierSet(address,uint128,uint128,uint128)": EventFragment;
...
export interface UnlockedBoostVault extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UnlockedBoostVaultInterface;
  ...
  functions: {
    MAX_HISTORY_LENGTH(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  filters: {
    ...
    "MultiplierSet(address,uint128,uint128,uint128)"(
      tokenAddress?: null,
      tokenId?: null,
      multiplier?: null,
      expiration?: null
