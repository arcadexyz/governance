...
export declare namespace ArcadeCoreVoting {
...
export interface ArcadeCoreVotingInterface extends utils.Interface {
  functions: {
    "DAY_IN_BLOCKS()": FunctionFragment;
    "allowNewVotingVaults()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "allowNewVotingVaults",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface VotedEventObject {
  voter: string;
  proposalId: BigNumber;
  vote: ArcadeCoreVoting.VoteStructOutput;
}
export type VotedEvent = TypedEvent<
  [string, BigNumber, ArcadeCoreVoting.VoteStructOutput],
  VotedEventObject
>;

export type VotedEventFilter = TypedEventFilter<VotedEvent>;

export interface ArcadeCoreVoting extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ArcadeCoreVotingInterface;
  ...
  functions: {
    ...
    allowNewVotingVaults(overrides?: CallOverrides): Promise<[boolean]>;
  ...
  estimateGas: {
    ...
    allowNewVotingVaults(overrides?: CallOverrides): Promise<BigNumber>;
