...
import fs from "fs";
import jsonData from "./data/combined/combined_airdrop_data.json";
...
export async function main() {
    ...
    fs.writeFileSync("scripts/airdrop/data/combined/combined_airdrop_data_bn.json", JSON.stringify(airdropData, null, 2));

    console.log("Airdrop data created and saved to scripts/airdrop/data/combined/combined_airdrop_data_bn.json");
}
