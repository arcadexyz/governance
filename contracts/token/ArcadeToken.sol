...
contract ArcadeToken is ERC20, ERC20Burnable, IArcadeToken, ERC20Permit {
    ...
    uint256 public constant initialDstAmount = 100_000_000 ether;
    ...
    constructor(address _minter, uint256 _mintingAllowedAfter) ERC20("Arcade", "ARCD") ERC20Permit("Arcade") {
        ...
        _mint(_minter, initialDstAmount);
    ...
    /**
     * @notice Function to change the minter address. Can only be called by current minter.
     *
