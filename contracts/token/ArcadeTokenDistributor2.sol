 ...
 * not hold any tokens.
 */
contract ArcadeTokenDistributor2 is Ownable {
    ...
    uint256 public constant treasuryAmount = 35_100_000 ether;
    /// @notice A flag to indicate if the treasury has already been transferred to
    bool public treasurySent;

    // separate treasury for the foundation
    // 10 million of 35.1 million ->> 25.1 million
